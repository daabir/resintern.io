       ...
       echo' 
         ...
         <div class="text-center">
                    ...
                    <ul class="social-network social-circle">
                        <li>
                          <a href="https://www.facebook.com/daabir.mubashir" target="_blank" class="icoFacebook darkbg" title="'.$face.'"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li>
                          <a href="https://www.twitter.com/daabir_mubashir" target="_blank" class="icoTwitter darkbg" title="'.$twitter.'"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li>
                        <a href="https://www.instagram.com/daabir_mubashir" target="_blank" class="icoInsta darkbg" title="'.$insta.'"><i class="fa fa-instagram"></i></a>
                        </li>
                        <li>
                        <a href="https://www.linkedin.com/in/mubashir-parwaz-dar-33247823a/" target="_blank" class="icoLinkedin darkbg" title="'.$linkdin.'"><i class="fa fa-linkedin"></i></a>
                        </li>
                    </ul>       
        </div>
        <br>       
