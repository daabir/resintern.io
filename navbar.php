    ...
    <div class="container topnav">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
             ...
             <a href="<?php echo 'https://localhost/resintern' ?>" class="logolink">
              <img src="https://localhost/resintern/img/icon-cv.svg" class="logo">&nbsp;
              <span class="h4">Build Easy Resume </span> 
             </a>
