...
<div class="row">
      ...
      <div class="col-md-3 col-sm-3">
            <div class="text-center bd">
                  ...
                  <img  width="130"  height="240" src="https://localhost/resintern/img/icon-cv2.svg" alt="icon-cv" >
            </div>
      ...
      <div class="col-md-3 col-sm-3" style="margin-left: 25px;">
            ...
            <div class="text-center bd">
                  ...
                  <img  width="150"  height="240" src="https://localhost/resintern/img/icon-build.svg" alt="icon-cv" >
            </div>
            <div class="text-center">
                  <br>
      ...
      <div class="col-md-3 col-sm-3" style="margin-left: 25px;">
            <div class="text-center bd">
                  ...
                  <img  width="150"  height="240" src="https://localhost/resintern/img/icon-download2.svg" alt="icon-cv" >
            </div>
            <div class="text-center">
                  <br>
