...
<div class="container-fluid bg-primary text-light text-center">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <picture class="icons">
                 <img  width="20"  height="30" src="https://localhost/resintern/img/icon-cv.svg" alt="icon-cv">
            </picture>
            <br><br><br>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <picture class="icons">
                 <img  width="20"  height="30" src="https://localhost/resintern/img/icon-pen.svg" alt="icon-cv">
            </picture>
            <br><br><br>
            <span class="text-center h4 tbold">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <picture class="icons">
                 <img  width="20"  height="30" src="https://localhost/resintern/img/icon-download.svg" alt="icon-cv">
            </picture>
            <br><br><br>
            <span class="text-center h4 tbold">
